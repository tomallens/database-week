...
```bash
psql -h 127.0.0.1 your_database_name < seeds_{books}.sql
```
...
books.length # => 2
books.first.title # => 'The Algebraist'
books.first.author # => 'Iain M Banks'

# find (id 2)
books.length # => 2
books.first.title # => 'The Dispossessed'
books.first.author # => 'Ursula le Guin'
